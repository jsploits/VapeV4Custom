...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/jsploits/VapeV4Custom/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/jsploits/VapeV4Custom/refs/heads/main/NewMainScript.lua)
...
<br/>
[JSploits](https://github.com/jsploits) - Customized the project, forked from 7GrandDad.
